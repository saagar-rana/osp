    ...
    if ((ae.preventDefault(), v(""), C(""), n && a && d && m)) {
      ...
      try {
        const ce = await cr.post(
          "https://sagarrana12.com.np/api/keys/get-activation-key/",
...
function uw() {
  const [e, t] = w.useState(null),
    ...
    me = (_) => {
      ...
      v(!0),
        cr
          .put("https://sagarrana12.com.np/api/keys/edit-key/", T)
          .then((M) => {
    ...
    Fe = (_) => {
      ...
      T.append("file", e),
        T.append("category", o),
        cr
          .post("https://sagarrana12.com.np/api/keys/upload-csv/", T, {
    ...
    N = (_) => {
      ...
      T.append("file", n),
        cr
          .post(
            "https://sagarrana12.com.np/api/keys/upload-activation-keys/",
            T,
            {
              headers: { "Content-Type": "multipart/form-data" },
            }
...
function xw() {
  ...
  async function m(y) {
    if ((y.preventDefault(), e && n)) {
      i(!0);
      try {
        const g = await cr.post("https://sagarrana12.com.np/api/keys/login/", {
          username: e,
          password: n,
        });
        console.log(g),
