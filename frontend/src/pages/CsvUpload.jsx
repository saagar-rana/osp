...
function CsvUpload() {
  ...
  const handleDeleteKeySubmit = (event) => {
    ...
    axios
      .delete(
        "https://kamleshkd.pythonanywhere.com/api/keys/delete_activation_keys/",
        {
          data: data,
        }
      )
  ...
  const handleAcKeyUpdate = (event) => {
    ...
    axios
      .put("https://kamleshkd.pythonanywhere.com/api/keys/edit-key/", data)
      .then((response) => {
        console.log(response);
  ...
  const handleCsvFileUpload = (event) => {
    ...
    axios
      .post(
        "https://kamleshkd.pythonanywhere.com/api/keys/upload-csv/",
        formData,
        {
          headers: {
  ...
  const handleAckFileUpload = (event) => {
    ...
    axios
      .post(
        "https://kamleshkd.pythonanywhere.com/api/keys/upload-activation-keys/",
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const fetchRecentlyUsedKeys = () => {
    axios
      .get("https://kamleshkd.pythonanywhere.com/api/keys/view_used_keys/")
      .then((response) => {
  ...
  const fetchUnusedKeys = () => {
    axios
      .get("https://kamleshkd.pythonanywhere.com/api/keys/view_unused_keys/")
      .then((response) => {
