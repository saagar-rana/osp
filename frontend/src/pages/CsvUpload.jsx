...
function CsvUpload() {
  ...
  const handleDeleteKeySubmit = (event) => {
    ...
    axios
      .delete("https://sagarrana12.com.np/api/keys/delete_activation_keys/", {
        data: data,
      })
      .then((response) => {
  ...
  const handleAcKeyUpdate = (event) => {
    ...
    axios
      .put("https://sagarrana12.com.np/api/keys/edit-key/", data)
      .then((response) => {
        console.log(response);
  ...
  const handleCsvFileUpload = (event) => {
    ...
    axios
      .post("https://sagarrana12.com.np/api/keys/upload-csv/", formData, {
        headers: {
  ...
  const handleAckFileUpload = (event) => {
    ...
    axios
      .post("https://sagarrana12.com.np/api/keys/upload-activation-keys/", formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      })
  ...
  const fetchRecentlyUsedKeys = () => {
    axios
      .get("https://sagarrana12.com.np/api/keys/view_used_keys/")
      .then((response) => {
  ...
  const fetchUnusedKeys = () => {
    axios
      .get("https://sagarrana12.com.np/api/keys/view_unused_keys/")
      .then((response) => {
